...
public:
    ...
    ~IArchiveOpenCallback_Wrapper() override = default;
...
public:
    ...
    ~ICryptoGetTextPassword_Wrapper() override = default;
...
public:
    ...
    ~ICryptoGetTextPassword2_Wrapper() override = default;
...
IMPLEMENT_IPROGRESS()
    ...
    ~IArchiveExtractCallback_Wrapper() override = default;
...
IMPLEMENT_IPROGRESS()
    ...
    ~IArchiveUpdateCallback_Wrapper() override = default;
...
public:
    MY_QUERYINTERFACE_BEGIN2(IInStream)MY_QUERYINTERFACE_END
...
public:
    MY_QUERYINTERFACE_BEGIN2(IOutStream)MY_QUERYINTERFACE_END
...
public:
    ...
    ~IInArchive_Wrapper() final = default;
...
public:
    ...
    ~IOutArchive_Wrapper() final = default;
...
public:
    ...
    ~ISetProperties_Wrapper() final = default;
